...
Asensin itselleni uuden virtuaalikoneen nimellä Hannanlabrakoe. Latasin sille Debian 12-Bookworm ja päivitin ohjelmistot komennolla $ sudo apt-get dist-upgrade ja latasin tulimuurin komennolla _$ sudo apt-get install ufw_.
