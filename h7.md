...
## d) Asensin itselleni uuden virtuaalikoneen nimellä Hannanlabrakoe. Latasuin sille Debian 12-Bookworm ja päivitetin ohjelmistot komennolla $ sudo apt-get dist-upgrade ja latasin tulimuurin komennolla
