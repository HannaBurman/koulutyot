...
Valitsin palveluntarjoajaksi Digital Oceanin (cloud.digitalocean.com). Tein sinne tunnukset, s-postia käyttäen.
...
Seuraavaksi valitsin create droplets jossa valisisn lähinnä olevan datacenterin, eli Amsterdamin. 
