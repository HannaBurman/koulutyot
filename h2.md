...
## d) FHS. Esittele kansiot, jotka on listattu "Command Line Basics Revisited" kappaleessa "Important directories". Näytä kuvaava esimerkki kunkin tärkeän kansion sisältämästä tiedostosta tai kansiosta. Jos kyseessä on tiedosto, näytä siitä kuvaava esimerkkirivi. Työskentele komentokehotteessa ja näytä komennot, joilla etsit esimerkit. 29.1.2024 klo 8.00-11.00
...
Kirjoitin komennon: grep Toivottavasti testailuja.txt mutta se ei tuottanut mitään. En oikein tajua miksi. Ajattelin, että ehkä kirjoitin tallennusbaiheessa jotain väärin, joten kirjoitin komennon grep Toivottavasti *.txt jolloin vastauksena tuli: Toivottavasti tämä onnistuu!!

<img width="492" alt="Näyttökuva 2024-1-29 kello 11 36 41" src="https://github.com/HannaBurman/koulutyot/assets/156779955/9cdd2ab9-a7f3-407f-a79a-434c3ab2bfc4">
