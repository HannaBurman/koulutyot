...
Kirjoitin komennon: grep Toivottavasti testailuja.txt mutta se ei tuottanut mitään, joten kirjoitin komennon grep Toivottavasti *.txt jolloin vastauksena tuli: Toivottavasti tämä onnistuu!! Toiseen tiedostoon en jostain syystä päässyt käsiksi, joten tein uuden identtisen tiedoston nanossa ja kokelin uudestaan, jolloin se onnistui!
