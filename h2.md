...
## b) Rauta. Listaa testaamasi koneen rauta (‘sudo lshw -short -sanitize’). Asenna lshw tarvittaessa. Selitä ja analysoi listaus. 26.1.2024 klo 8.45-
...
Järjestelmä (System): Laitetunniste (H/W path): VirtualBox
Muisti (Memory): BIOS: 128 KiB
Järjestelmämuisti (System memory): 4 GiB
Prosessori (Processor): Merkki ja malli: Intel(R) Core(TM) i5-8257U CPU @ 1
Emolevy (Motherboard): Tyyppi: 440FX - 82441FX PMC [Natoma]
Sovitin (Adapter): Näytönohjain (Display): SVGA II Adapter
Verkkoyhteys (Network): Verkkokortti (Network controller): 82540EM Gigabit Ethernet Controller
Muut laitteet: 
CD-ROM: CD-ROM
USB-liitännät (USB): KeyLargo/Intrepid USB
Äänikortti (Audio Controller): 82801AA AC'97 Audio Controller
USB-liitäntä (USB): OHCI PCI host controller
USB Tablet: Input device (USB Tablet)
ACPI-silta (ACPI Bridge): 82371AB/EB/MB PIIX4 ACPI
EHCI Host Controller: USB 2.0 -tuki
Tallennus (Storage):
Kiintolevy (Hard Disk): 64 GB VBOX HARDDISK
Osio 1 (Partition 1): 59 GiB EXT4 volume
Osio 2 (Partition 2, laajennettu osio): 975 MiB
Osio 5 (Partition 5, swap-osiota): 975 MiB Linux swap volume
Muut laitteet (Input devices):
PnP-laitteet: PnP device PNP0303 ja PnP device PNP0f03
